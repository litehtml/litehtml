...
static void CssElementSelectorParseTest() {
  ...
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("default")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":disabled"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("disabled")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":empty"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("empty")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":enabled"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("enabled")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":first-child"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("first-child")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t("::first-letter"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("first-letter")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo-el")));
  assert(selector.m_attrs[0].condition == select_pseudo_element);
  selector.parse(_t("::first-line"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("first-line")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo-el")));
  assert(selector.m_attrs[0].condition == select_pseudo_element);
  selector.parse(_t(":first-of-type"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("first-of-type")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":focus"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("focus")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":hover"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("hover")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":in-range"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("in-range")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":indeterminate"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("indeterminate")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":invalid"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("invalid")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":lang(language)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("lang(language)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":last-child"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("last-child")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":last-of-type"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("last-of-type")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":link"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("link")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":not(selector)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("not(selector)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":nth-child(n)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("nth-child(n)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":nth-last-child(n)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("nth-last-child(n)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":nth-last-of-type(n)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("nth-last-of-type(n)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":nth-of-type(n)"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("nth-of-type(n)")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":only-of-type"));
  assert(selector.m_tag.empty()), assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("only-of-type")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":only-child"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("only-child")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":optional"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("optional")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":out-of-range"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("out-of-range")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t("::placeholder"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("placeholder")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo-el")));
  assert(selector.m_attrs[0].condition == select_pseudo_element);
  selector.parse(_t(":read-only"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("read-only")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":read-write"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("read-write")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":required"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("required")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":root"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("root")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t("::selection"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("selection")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo-el")));
  assert(selector.m_attrs[0].condition == select_pseudo_element);
  selector.parse(_t(":target"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("target")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":valid"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("valid")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  selector.parse(_t(":visited"));
  assert(selector.m_tag.empty());
  assert(selector.m_attrs.size() == 1);
  assert(!t_strcmp(selector.m_attrs[0].val.c_str(), _t("visited")));
  assert(!t_strcmp(selector.m_attrs[0].attribute.c_str(), _t("pseudo")));
  assert(selector.m_attrs[0].condition == select_pseudo_class);
  // other
