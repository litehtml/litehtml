...
namespace html2png
{
	...
	class container : public container_cairo_pango
	{
	  ...
	  public:
		...
		{
			return m_converter->get_dpi();
		}
		int get_screen_width() const override
		{
			return m_converter->get_screen_width();
		}
		int get_screen_height() const override
		{
			return m_converter->get_screen_height();
		}
		...
		{
			return m_converter->get_default_font();
		}
		cairo_font_options_t* get_font_options() override
		{
			return m_converter->get_font_options();
		}
