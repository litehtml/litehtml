...
namespace litehtml
{
	...
	public:
		...
		virtual vector<image>		get_images_property (string_id name, bool inherited, const std::vector<image>& default_value, uint_ptr css_properties_member_offset) const;
