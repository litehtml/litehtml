...
namespace litehtml
{
	...
	public:
		...
		virtual std::vector<background_image> get_images_property (string_id name, bool inherited, const std::vector<background_image>& default_value, uint_ptr css_properties_member_offset) const;
