...
namespace litehtml
{
	...
	protected:
		 ...
		 */
		virtual int _render_content(int /*x*/, int /*y*/, bool /*second_pass*/, const containing_block_context& /*self_size*/, formatting_context* /*fmt_ctx*/, time /*t*/) { return 0; }
		...
		int place_float(const std::shared_ptr<render_item>& el, int top, const containing_block_context& self_size, formatting_context* fmt_ctx, time t);
		virtual void fix_line_width(element_float /*flt*/,
									const containing_block_context& /*containing_block_size*/, formatting_context* /*fmt_ctx*/, time /*t*/)
		{}
